...
const surveyURL = 'https://www.questionpro.com/t/AU3XfZrPIS';
const welcomeImg = '../images/logo.svg';
...
function welcomeUser() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            let message = {
                email: '',
                subject: 'Please join our Codeally Video Chat Meeting',
...
function setTheme(theme) {
    ...
    switch (mirotalkTheme) {
        case 'neon':
            // neon theme
            swalBackground = '#22272e';
            document.documentElement.style.setProperty('--body-bg', '#22272e');
